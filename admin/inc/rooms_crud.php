...
if (isset($_POST['add_room'])) 
{
	...
	$q1 = "INSERT INTO `rooms`(`name`, `price`, `quantity`, `description`) VALUES (?,?,?,?)";
...
if (isset($_POST['edit_room']))
{
	...
	$q1 = "UPDATE `rooms` SET `name`=?,`price`=?,`quantity`=?,`description`=? WHERE `id`=?";
	$values = [$frm_data['name'], $frm_data['price'], $frm_data['quantity'], $frm_data['desc'], $frm_data['room_id']];
